...
export default function Header() {
  return (
    <>
      ...
      <Disclosure as="nav" className="bg-white shadow" id="home">
        {({ open }) => (
          <>
              ...
              <div className="relative flex justify-between h-16">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  <Menu as="div" className="ml-3 relative">
                    <div>
                      <Menu.Button className="bg-white rounded-full flex text-sm focus:outline-none focus:ring-3 focus:ring-offset-2 focus:ring-grey-500">
                    ...
                    >
                      <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <Menu.Item>
                          {({ active }) => (
                            <a
                              href="https://github.com/zpuckettdesign"
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <a
                              href="https://www.linkedin.com/in/zach-puckett1/"
                              className={classNames(
                                active ? "bg-gray-100" : "",
                                "block px-4 py-2 text-sm text-gray-700"
                              )}
